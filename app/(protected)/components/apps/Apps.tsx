...
export default function AppsMenu() {
  ...
  // const navigation = allowedApps.filter((item) => access?.includes(item.key));
  ...
  return (
    <>
      ...
      <div
        className="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded bg-white pl-4 text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
        id="apps-dropdown"
      >
          ...
          {allowedApps?.map((appsAccess) => {
            return (
              <Link
                ...
                className="group block grid grid-rows-2 justify-center rounded-lg p-4 text-center hover:bg-gray-100 dark:hover:bg-gray-600"
              >
